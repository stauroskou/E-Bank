...
namespace assessement
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            signup(validate,ID,unique, encryption, randommoney1, path,textBox1.Text,textBox2.Text,textBox3.Text,textBox4.Text);
        }
        ...
        public bool validation(string text1, string text2, string text3, string text4)
            {
              if (!is_only_eng_letters_and_digits(text1) || !firstnameandlastname(text2) || !firstnameandlastname(text3) || !IsFirstNumber(text1) || !hasSpecialChar(text4) || !HasCapitalsDigitsLowers(text4)
                  || !Contains(text4, text1) || !Contains(text4, text2) || !Contains(text4, text3)||panumber(text4))
              {
                  return false;
              }
              else
        ...
        public void signup(bool validate,string ID,bool unique,string encryption,string randommoney1,string path,string text1,string text2,string text3,string text4)
        {
            if (text1.Length < 6 || text1.Length > 20 || text2.Length <= 3 || text3.Length <= 3 || text4.Length <= 8 || text4.Length > 25 || !validate)
            {
                PasswordError();
            }
            else if (!unique)
            ...
            {
                appendlines(ID, text1, text2, text3, encryption, randommoney1, path);
            }
